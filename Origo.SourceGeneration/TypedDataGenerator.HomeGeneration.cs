...
public sealed partial class TypedDataGenerator
{
    ...
    private static void GenerateKindMap(SourceBuilder sb, List<InlineTypeInfo> types)
    {
    ...
    private static void GenerateHomeKindRegistration(SourceBuilder sb, List<InlineTypeInfo> types)
    {
    ...
    private static void GenerateStringConversion(SourceBuilder sb)
    {
        sb.AppendLine("partial struct TypedData");
        sb.AppendLine("{");
    ...
    private static void GenerateIsProperties(SourceBuilder sb, List<InlineTypeInfo> types)
    {
        sb.AppendLine("partial struct TypedData");
        sb.AppendLine("{");
    ...
    private static void GenerateAsMethods(SourceBuilder sb, List<InlineTypeInfo> types)
    {
    ...
    private static void GenerateTryGetMethods(SourceBuilder sb, List<InlineTypeInfo> types)
    {
        var inlineTypes = types.Where(t => t.FitsInline).ToList();
        if (inlineTypes.Count == 0) return;
    ...
    private static void GenerateExplicitConversions(SourceBuilder sb, List<InlineTypeInfo> types)
    {
        var inlineTypes = types.Where(t => t.FitsInline).ToList();
        if (inlineTypes.Count == 0) return;
    ...
    private static void GenerateTypedDataTypeMap(SourceBuilder sb, List<InlineTypeInfo> types)
    {
    ...
    private static void GenerateTypedDataObjectConverter(SourceBuilder sb, List<InlineTypeInfo> types)
    {
