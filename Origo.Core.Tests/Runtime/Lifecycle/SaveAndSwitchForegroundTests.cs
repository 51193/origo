...
public class SaveAndSwitchForegroundTests
{
    ...
    public void SaveBackgroundWithEntities_ThenSwitchForeground_LoadsEntitiesIntoForeground()
    {
        ...
        bg.SceneHost.CreateEntity(CreateMeta("BgEntity1"));
        bg.SceneHost.CreateEntity(CreateMeta("BgEntity2"));
    ...
    public void SaveBackgroundSession_ThenSwitch_WritesAllLevelDataToCurrent()
    {
        ...
        using var bg = ctx.SessionManager.CreateBackgroundSession("bg", "game", true);
        bg.SceneHost.CreateEntity(CreateMeta("DiskEntity"));
    ...
    public void SaveBackgroundSession_ThenSwitch_ThenReloadFromSnapshot_EntitiesPreserved()
    {
        ...
        using var bg = ctx.SessionManager.CreateBackgroundSession("bg", "game", true);
        bg.SceneHost.CreateEntity(CreateMeta("Entity1"));
        bg.SceneHost.CreateEntity(CreateMeta("Entity2"));
    ...
    public void SwitchForeground_WithoutSave_WhenTargetLevelInBackgroundSession_LoadsEntities()
    {
        ...
        using var bg = ctx.SessionManager.CreateBackgroundSession("bg", "game", true);
        bg.SceneHost.CreateEntity(CreateMeta("DirectEntity"));
        ...
        bool flushBetween)
    {
        ...
        using var bg = ctx.SessionManager.CreateBackgroundSession("bg", "game", true);
        bg.SceneHost.CreateEntity(CreateMeta("QueueEntity"));
    ...
    public void SwitchForeground_AutoPersistsOldForegroundSessionToCurrent()
    {
        ...
        fgBefore.SceneHost.CreateEntity(CreateMeta("OldFgEntity"));
    ...
    public void SwitchForeground_BackgroundSessionEntitiesUntouched()
    {
        ...
        bg.SceneHost.CreateEntity(CreateMeta("BgSurvivor1"));
        bg.SceneHost.CreateEntity(CreateMeta("BgSurvivor2"));
    ...
    public void SaveBackgroundSession_ManyEntities_ThenSwitch_AllLoaded()
    {
        ...
        for (var i = 0; i < EntityCount; i++)
            bg.SceneHost.CreateEntity(CreateMeta($"Entity_{i:D3}"));
    ...
    public void SwitchForeground_ToSameLevel_ReloadsFromCurrent()
    {
        ...
        var oldFg = ctx.SessionManager.ForegroundSession;
        Assert.NotNull(oldFg);
        oldFg.SceneHost.CreateEntity(CreateMeta("SameEntity"));
    ...
    public void SwitchForeground_BackgroundCollision_PreservesBackgroundData()
    {
        ...
        using var bg = ctx.SessionManager.CreateBackgroundSession("bg", "game", true);
        bg.SceneHost.CreateEntity(CreateMeta("PreservedEntity"));
    ...
    public void SwitchForeground_BackgroundCollision_OtherBackgroundsUntouched()
    {
        ...
        target.SceneHost.CreateEntity(CreateMeta("TargetEntity"));
        using var survivor = ctx.SessionManager.CreateBackgroundSession("survivor", "other_level", true);
        survivor.SceneHost.CreateEntity(CreateMeta("SurvivorEntity"));
    ...
    public void SwitchForeground_BackgroundCollision_WithForegroundActive()
    {
        ...
        var oldFg = ctx.SessionManager.ForegroundSession;
        Assert.NotNull(oldFg);
        oldFg.SceneHost.CreateEntity(CreateMeta("OldFgEntity"));
    ...
    public void SwitchForeground_BackgroundCollision_NoDataLossRoundTrip()
    {
        ...
        using var target = ctx.SessionManager.CreateBackgroundSession("target", "game", true);
        target.SceneHost.CreateEntity(CreateMeta("TargetEntity1"));
        target.SceneHost.CreateEntity(CreateMeta("TargetEntity2"));
    ...
    public void SwitchForeground_BackgroundCollision_DeferredQueueHandling()
    {
        ...
        using var target = ctx.SessionManager.CreateBackgroundSession("target", "game", true);
        target.SceneHost.CreateEntity(CreateMeta("DeferredEntity"));
