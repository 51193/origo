...
- **Godot upgraded to 4.7.2** — `Godot.NET.Sdk` now targets 4.7.2 in both the adapter and headless integration-test project, keeping the CI-downloaded engine aligned with the runtime dependency.
