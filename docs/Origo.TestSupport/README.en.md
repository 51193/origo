...
|------------|-------------|
| [Architecture](Architecture/README.en.md) | `PrivateFieldNamingConvention` naming guard, shell API classification completeness guard, TypedData test reset helper, and test-side frame-flush driver |
