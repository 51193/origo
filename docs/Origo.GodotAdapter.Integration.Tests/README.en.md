...
| ObserverSaveReloadIntegrationTests | `Tests/ObserverSaveReloadIntegrationTests.cs` | 2 | Observer bindings restored across save/load; session destroy fires OnUnmounted |
