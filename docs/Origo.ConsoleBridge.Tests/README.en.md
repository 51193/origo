...
| Architecture | [Architecture.md](Architecture.en.md) | Assembly dependency direction (no Godot / GodotAdapter dependency), private `_camelCase` field naming, shell API classification completeness |
