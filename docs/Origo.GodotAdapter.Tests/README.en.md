...
| SND Entities | [Snd.md](Snd.en.md) | 3 | 26 | SndEntityCollection full capability with batch recovery rollback, assembly-load-triggered kind registration, node extension contracts |
