...
| SND Entities | [Snd.md](Snd.en.md) | 3 | 21 | SndEntityCollection full capability with batch recovery rollback, TypedDataInitializer forced loading, node extension contracts |
