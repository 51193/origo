...
| [shell-package-consumer](shell-package-consumer.zh.md) | 发布/集成维护者 | shell-only 包消费 fixture：本地 feed restore、warning-as-error 构建、kernel 泄漏负向探测与 Godot headless 启动 |
