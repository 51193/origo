...
|-------|------|-------------|
| `Name` | `string` | Entity stable identifier name; callers must keep it unique within a session (lookup, observer topology, save recovery, and `IsSameEntityAs` key on names) |
