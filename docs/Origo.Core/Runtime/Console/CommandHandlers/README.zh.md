...
> [↑ 回到 Console](../README.zh.md) · [↔ Usage: console-commands](../../../../usage/console-commands.zh.md)
...
| `KillAllCommandHandler.cs` | `kill_all` | 立即标记所有实体为待销毁（帧末统一执行） |
