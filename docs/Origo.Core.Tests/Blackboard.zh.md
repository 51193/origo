...
> [↔ 被测模块: Origo.Core.Contracts/Blackboard](../Origo.Core.Contracts/Blackboard/README.zh.md)
...
| `Blackboard_SetValue_OverwriteExisting` | 覆盖写入返回最新值 | Blackboard Abstraction |
