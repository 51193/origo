...
public class GodotSndManagerCreationIntegrationTests : IDeferredTestFixture, System.IDisposable
{
    ...
    public void CreateEntity_AfterBind_EntityInList()
    {
        ...
        var entity = ((ISndSceneHost)_harness.SndManager).CreateEntity(meta);
    ...
    public void RemoveEntity_RemovesFromList()
    {
        ...
        ((ISndSceneHost)_harness.SndManager).CreateEntity(meta);
        ((ISndSceneHost)_harness.SndManager).RemoveEntity("test_remove");
    ...
    public void BuildMetaList_IncludesCreatedEntities()
    {
        ...
        ((ISndSceneHost)_harness.SndManager).CreateEntity(CreateMeta("meta_a"));
        ((ISndSceneHost)_harness.SndManager).CreateEntity(CreateMeta("meta_b"));

        var metaList = ((ISndSceneAccess)_harness.SndManager).BuildMetaList();
    ...
    public void RequestKillEntity_MarksPendingKill()
    {
        ...
        ((ISndSceneHost)_harness.SndManager).CreateEntity(meta);
        ((ISndSceneHost)_harness.SndManager).RequestKillEntity("test_kill");
    ...
    public void GetEntities_CountReflectsCreated()
    {
        ...
        ((ISndSceneHost)_harness.SndManager).CreateEntity(CreateMeta("count_test"));
