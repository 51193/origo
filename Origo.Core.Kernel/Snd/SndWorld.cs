...
/// </summary>
public sealed class SndWorld : ISndWorldAccess
{
    ...
    /// </summary>
    public SndMetaData ResolveTemplate(string templateAlias) => CloneMetaData(Mappings.ResolveTemplate(templateAlias));

    SndMetaData ISndWorldAccess.CloneMetaData(SndMetaData meta) => CloneMetaData(meta);
    ...
    public DataSourceNode WriteMetaNode(SndMetaData meta) => ConverterRegistry.Write(meta);
