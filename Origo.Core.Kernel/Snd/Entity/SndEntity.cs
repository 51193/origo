...
///     </para>
/// </summary>
public sealed class SndEntity : ISndEntity, IEntityLifecycle, ISndEntityRawSubscription, ISndEntityStrategyQuery
{
    ...
    bool ISndEntityStrategyQuery.HasStrategyMounted(string index) => HasStrategyMounted(index);
