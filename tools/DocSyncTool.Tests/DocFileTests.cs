...
public class DocFileTests
{
    ...
    [Fact]
    public void ExtractLanguage_NoSuffix_ReturnsEmpty() => Assert.Equal("", DocFile.ExtractLanguage("README.md"));

    [Fact]
    public void ExtractLanguage_NoDotAtAll_ReturnsEmpty() => Assert.Equal("", DocFile.ExtractLanguage("README"));
